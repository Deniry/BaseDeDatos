...
GO
PRINT N'Creando Tabla [dbo].[ENFERMEDADES]...';
...
CREATE TABLE [dbo].[ENFERMEDADES] (
    ...
    [Imagen]           IMAGE            NULL,
    CONSTRAINT [ENFERMEDADES_PK] PRIMARY KEY CLUSTERED ([EnfermedadId] ASC)
);
...
CREATE TABLE [dbo].[SUCULENTAS] (
    ...
    [EnfermedadId]    UNIQUEIDENTIFIER NOT NULL,
    [NombreSuculenta] VARCHAR (200)    NOT NULL,
    [Descripcion]     VARCHAR (MAX)    NULL,
    [Imagen]          IMAGE            NULL,
    CONSTRAINT [SUCULENTAS_PK] PRIMARY KEY NONCLUSTERED ([SuculentasId] ASC)
);
...
GO
PRINT N'Creando Restricción DEFAULT restricción sin nombre en [dbo].[ENFERMEDADES]...';


GO
ALTER TABLE [dbo].[ENFERMEDADES]
    ADD DEFAULT NEWID() FOR [EnfermedadId];


GO
PRINT N'Creando Restricción DEFAULT restricción sin nombre en [dbo].[SUCULENTAS]...';


GO
ALTER TABLE [dbo].[SUCULENTAS]
    ADD DEFAULT NEWID() FOR [SuculentasId];


GO
PRINT N'Creando Clave externa [dbo].[SUCULENTAS_FK0]...';


GO
ALTER TABLE [dbo].[SUCULENTAS]
    ADD CONSTRAINT [SUCULENTAS_FK0] FOREIGN KEY ([EnfermedadId]) REFERENCES [dbo].[ENFERMEDADES] ([EnfermedadId]);
